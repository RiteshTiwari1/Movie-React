...
//         const res=await axios.get(`https://api.themoviedb.org/3/movie/popular?api_key=%24`);
//         let data=res.data;
...
//                                 <h5 className="card-title movies-title">Card title</h5>
//                                 {/* <p className="card-text movies-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p> */}
